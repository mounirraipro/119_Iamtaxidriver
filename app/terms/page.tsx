...
export const metadata: Metadata = {
    ...
    description: 'Read the I Am Taxi Driver Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['I Am Taxi Driver terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to I Am Taxi Driver. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing I Am Taxi Driver at iamtaxidriver.com, you acknowledge that you have read,
                ...
                <p>
                    I Am Taxi Driver provides a free, browser-based game. I Am Taxi Driver is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    I Am Taxi Driver is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on I Am Taxi Driver — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of I Am Taxi Driver or its
                ...
                <p>
                    ...
                    I Am Taxi Driver for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using I Am Taxi Driver, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant I Am Taxi Driver a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    I Am Taxi Driver displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    I Am Taxi Driver is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, I Am Taxi Driver and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to I Am Taxi Driver at our sole
                ...
                <p>
                    ...
                    <strong>legal@iamtaxidriver.com</strong>.
                </p>
            </div>
        </>
    );
