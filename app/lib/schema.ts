...
const SITE_URL = 'https://iamtaxidriver.com';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'I Am Taxi Driver',
        url: SITE_URL,
        description: 'Play I Am Taxi Driver free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play I Am Taxi Driver online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
