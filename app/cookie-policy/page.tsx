...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies I Am Taxi Driver uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['I Am Taxi Driver cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how I Am Taxi Driver uses them, and how you can
                ...
                <p>I Am Taxi Driver uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on I Am Taxi Driver.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@iamtaxidriver.com</strong>.
                </p>
            </div>
        </>
    );
