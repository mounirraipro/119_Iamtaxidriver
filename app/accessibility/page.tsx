...
export const metadata: Metadata = {
    ...
    description: 'I Am Taxi Driver is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['I Am Taxi Driver accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making I Am Taxi Driver accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    I Am Taxi Driver is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of I Am Taxi Driver presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of I Am Taxi Driver. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@iamtaxidriver.com</strong></li>
                </ul>
                <p>
