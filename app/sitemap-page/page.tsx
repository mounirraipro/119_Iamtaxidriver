...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of I Am Taxi Driver. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['I Am Taxi Driver sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play I Am Taxi Driver' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is I Am Taxi Driver?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on I Am Taxi Driver.</p>
                </div>
            </div>
